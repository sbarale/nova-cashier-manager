...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        loadUserData: function loadUserData() {
            ...
            axios.get('/nova-cashier-tool-api/user/' + this.resourceId + '/?brief=true').then(function (response) {
                _this.user = response.data.user;
                _this.subscription = response.data.subscription;
                _this.addon_subscriptions = response.data.addon_subscriptions;
          ...
          ? _c("div", { staticClass: "flex border-b border-40" }, [
              ...
              _c("div", { staticClass: "w-3/4 py-4" }, [
                _c("p", { staticClass: "text-90" }, [
                  _vm._v(
                    "\n                " +
                      _vm._s(_vm.subscription.stripe_id) +
                      "\n                ·\n                "
                  ),
                  _c(
                    "a",
                    {
                      ...
                      attrs: {
                        href:
                          ...
                          _vm.subscription.stripe_id,
                        target: "_blank"
                      }
                    },
                    [_vm._v("View on Stripe")]
                  )
                ])
              ])
            ])
              ...
              [
                _c(
                  ...
                  [
                    ...
                    _c(
                      "tbody",
                      _vm._l(_vm.addon_subscriptions, function(addon) {
                        return _c("tr", [
                          _c("td", [
                            _c("strong", [
                              _vm._v(
                                _vm._s(addon.addon.name) +
                                  " " +
                                  _vm._s(addon.addonPlan.name)
                              )
                            ]),
                          ...
                          _c("td", [
                            _vm._v(
                              _vm._s(addon.addonPlan.price) +
                                " / " +
                                _vm._s(
                                  addon.addonPlan.usageType == "licensed"
                                    ? addon.addonPlan.interval
                                    : addon.addonPlan.unit
                                )
                            )
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            addon.addonPlan.usageType == "metered"
                              ? _c("span", [
                                  _vm._v(
                                    "\n                                " +
                                      _vm._s(addon.current_usage) +
                                      " " +
                                      _vm._s(addon.addonPlan.unit) +
                                      "\n                            "
                                  )
                                ])
                              : _c("span", [
                                  _vm._v(_vm._s(addon.subscription.quantity))
                                ])
                          ])
                        ])
                      }),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        loadUserData: function loadUserData() {
            ...
            axios.get('/nova-cashier-tool-api/user/' + this.userId).then(function (response) {
                _this.user = response.data.user;
                _this.subscription = response.data.subscription;
                _this.addon_subscriptions = response.data.addon_subscriptions;
        ...
        cancelSubscription: function cancelSubscription() {
            ...
            axios.post('/nova-cashier-tool-api/user/' + this.userId + '/cancel').then(function (response) {
        ...
        resumeSubscription: function resumeSubscription() {
            ...
            axios.post('/nova-cashier-tool-api/user/' + this.userId + '/resume').then(function (response) {
        ...
        updateSubscription: function updateSubscription() {
            ...
            axios.post('/nova-cashier-tool-api/user/' + this.userId + '/update', { plan: this.newPlan }).then(function (response) {
         ...
         */
        cancelAddonSubscription: function cancelAddonSubscription(id) {
            var _this6 = this;

            this.loading = true;

            axios.post('/nova-cashier-tool-api/user/' + this.userId + '/cancel-addon/' + id).then(function (response) {
                _this6.$toasted.show("Cancelled add-on successfully!", { type: "success" });

                _this6.loadUserData();
            }).catch(function (errors) {
                _this6.$toasted.show(errors.response.data.message, { type: "error" });
            });
        },
         ...
         * Resume subscription.
         */
        resumeAddonSubscription: function resumeAddonSubscription(id) {
            var _this7 = this;

            this.loading = true;

            axios.post('/nova-cashier-tool-api/user/' + this.userId + '/resume-addon/' + id).then(function (response) {
                _this7.$toasted.show("Resumed add-on successfully!", { type: "success" });

                _this7.loadUserData();
            }).catch(function (errors) {
                _this7.$toasted.show(errors.response.data.message, { type: "error" });
            });
        }
    }
});
                            ...
                            return _c("tr", [
                              ...
                              _c("td", [
                                addon.addonPlan.usageType == "metered"
                                  ...
                                  : _c("span", [
                                      _vm._v(
                                        _vm._s(addon.subscription.quantity)
                                      )
                                    ])
                              ]),
                              _vm._v(" "),
                              _c("td", [
                                addon.on_grace_period
                                  ? _c("span", [_vm._v("On Grace Period")])
                                  : _vm._e(),
                                _vm._v(" "),
                                addon.cancelled || addon.cancel_at_period_end
                                  ? _c("span", { staticClass: "text-danger" }, [
                                      _vm._v("Cancelled")
                                    ])
                                  : _vm._e(),
